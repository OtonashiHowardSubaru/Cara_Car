...
export default {
  ...
  methods: {
    ...
    getProductImgSrc(imgName){
      return new URL(`${import.meta.env.VITE_IMG_BASE_URL}/product/new_products/${imgName}`, import.meta.url).href
    },
  }
}
</script>
<template>
    ...
    <div class="product_card" v-for="item in displayData" :key="item.pro_id">
