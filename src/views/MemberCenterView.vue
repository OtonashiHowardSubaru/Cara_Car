  ...
  <div class="memberCenter">
    ...
    <div class="memberContent">
      ...
      <div class="order" v-show="currentProfile === 'order'">
        ...
        <div class="order_content" v-show="currentOrder === 'noPay'">
          <!-- <div v-if="currentOrder > 0" v-show="currentOrder === 'noPay'" class="order_content" -->

          <div class="order_empty">
            <!-- <div class="empty_img">
                            <img
                                src="@/assets/imgs/memberCenter/order-empty-image.png"
                                alt="noOrder"
                            />
                        </div>
                        <p class="order_none">尚未有訂單</p> -->
          </div>
          <!-- <div class="order_card" v-for="orderItems in orderList" :key="orderItems"> -->
          <div class="order_card">
            <div class="card_intro">
              <div class="order_proImg">
                <!-- <img :src="getProImg(URL)" alt=""> -->
