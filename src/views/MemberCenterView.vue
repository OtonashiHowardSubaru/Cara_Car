...
export default {
    ...
    methods: {
        ...
        axiosGetMem(){
            ...
            axios.get(`${import.meta.env.VITE_LPHP_URL}/front/getMemberName.php?member_id=${member_id}`)
            .then(res => {
        ...
        showFile(e) {
            ...
            axios.post(`${import.meta.env.VITE_LPHP_URL}/front/updateMemberImg.php?`,formData, {
                    headers: {
        ...
        updateMemProfile() {
            ...
            axios.post(`${import.meta.env.VITE_LPHP_URL}/front/updateMemberProfile.php`, postData, {
        ...
        getProductImgSrc(imgName) {
            return new URL(`${import.meta.env.VITE_LIMG_BASE_URL}/sh_product/${imgName}`, import.meta.url).href
        },
        updateImgName() {
