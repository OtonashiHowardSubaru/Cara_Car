...
export default {
  ...
  methods: {
    fetchData() {
      ...
      // 取得這一份商品的全部圖片名稱
      axios.get(`${import.meta.env.VITE_PHP_URL}/front/thisproductimgs.php?pageId=${pageId}`)
        .then((response) => {
    ...
    <div class="row">
      ...
      <div class="col-12 col-md-6 pro_img_switcher">
        ...
        <div class="smallImgsBox">
          <!-- 圖片們 -->
          <img v-for="item in ImgsName" :src="getProductImgSrc(item.img_name)" alt="" class="smallImg " :key="item"
      ...
      <div class="col-12 col-md-6 intro">
        ...
        <div class="buy_pro">
          <div class="toggle_favorite">
            <svg xmlns="http://www.w3.org/2000/svg" width="38" height="34" viewBox="0 0 38 34" fill="red"
      ...
      <div class="col-12">
        <ProductIntroCard :productInfo="allProducts" />
